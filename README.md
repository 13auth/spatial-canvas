...
**Version:** 0.49.0 (M0–M52) · **Platform:** Windows 11
...
| Zone frame (group windows) | **Ctrl+Shift+Z** = labeled region · drag the **title bar** to move (body is click-through) · corner = resize |
